    ...
    <section className={classes.introd}>
      <div className={classes.container}>
         <h3>Доброго вечора. Ми з України.</h3>
          ...
          <p>Цей веб портал створено для оприлюднення свіжих та провірених новин. Тільки провірені новини в галузі бізнеса та економіки. Ми прфціюми заради вас та перемоги</p>
